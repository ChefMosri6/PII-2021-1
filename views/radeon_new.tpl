...
<html lang="en">
    ...
    <body>
        <header>
            ...
            <nav>
            <ul>
                <li> <a href="index.html"style="color:rgb(0,0,0);"NOTE>Home</li></a>
                <li><a  href="Nvidia.html"style="color:rgb(0,0,0);"NOTE> Nvidia</li></a>
                <li> <a href="radeon.html"style="color:rgb(0,0,0);"NOTE>Radeon</li></a>
                <li> <a href="contact.html"style="color:rgb(0,0,0);"NOTE>Contact</li></a>
             </ul>
             </nav>
